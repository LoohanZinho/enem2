  ...
  const [templates] = useState<SpreadsheetTemplate[]>([
    {
      ...
      data: [
        { 'Nome do Aluno': {value: 'João Silva', type: 'text'}, 'Aula': {value: 'Matemática', type: 'text'}, 'Presença': {value: 'Presente', type: 'text'}, 'Nota': {value: '8.5', type: 'text'}, 'Data': {value: new Date().toISOString().split('T')[0], type: 'text'} },
        { 'Nome do Aluno': {value: 'Maria Santos', type: 'text'}, 'Aula': {value: 'Português', type: 'text'}, 'Presença': {value: 'Presente', type: 'text'}, 'Nota': {value: '9.2', type: 'text'}, 'Data': {value: new Date().toISOString().split('T')[0], type: 'text'} },
        { 'Nome do Aluno': {value: 'Pedro Costa', type: 'text'}, 'Aula': {value: 'Física', type: 'text'}, 'Presença': {value: 'Falta', type: 'text'}, 'Nota': {value: '7.0', type: 'text'}, 'Data': {value: new Date().toISOString().split('T')[0], type: 'text'} }
      ],
    ...
    },
    {
      ...
      data: [
        { 'Matéria': {value: 'Matemática', type: 'text'}, 'Tópico': {value: 'Álgebra', type: 'text'}, 'Horas': {value: '4', type: 'text'}, 'Status': {value: 'Concluído', type: 'text'}, 'Data': {value: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], type: 'text'} },
        { 'Matéria': {value: 'Português', type: 'text'}, 'Tópico': {value: 'Literatura', type: 'text'}, 'Horas': {value: '3', type: 'text'}, 'Status': {value: 'Em Andamento', type: 'text'}, 'Data': {value: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], type: 'text'} },
        { 'Matéria': {value: 'Física', type: 'text'}, 'Tópico': {value: 'Mecânica', type: 'text'}, 'Horas': {value: '5', type: 'text'}, 'Status': {value: 'Pendente', type: 'text'}, 'Data': {value: new Date().toISOString().split('T')[0], type: 'text'} }
      ],
    ...
    },
    {
      ...
      data: [
        { 'Título': {value: 'Aula 1 - Introdução', type: 'text'}, 'Matéria': {value: 'Matemática', type: 'text'}, 'Duração': {value: '45min', type: 'text'}, 'Status': {value: 'Publicado', type: 'text'}, 'Visualizações': {value: '150', type: 'text'} },
        { 'Título': {value: 'Aula 2 - Exercícios', type: 'text'}, 'Matéria': {value: 'Matemática', type: 'text'}, 'Duração': {value: '60min', type: 'text'}, 'Status': {value: 'Rascunho', type: 'text'}, 'Visualizações': {value: '0', type: 'text'} },
        { 'Título': {value: 'Resumo - Literatura', type: 'text'}, 'Matéria': {value: 'Português', type: 'text'}, 'Duração': {value: '30min', type: 'text'}, 'Status': {value: 'Publicado', type: 'text'}, 'Visualizações': {value: '89', type: 'text'} }
      ],
